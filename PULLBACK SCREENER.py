...
def analyse_ticker(ticker_raw, ticker_frame, min_score=DEFAULT_MIN_SCORE, latest_date=None):
    ...
    fix - see price_cache.py's docstring for why."""
    ...
    try:
        ...
        lo_date = dates[lo_idx]
        hi_date = dates[hi_idx]
...
def main():
    ...
    results, usable = run_scan(tickers, min_score=args.min_score, workers=args.workers)
